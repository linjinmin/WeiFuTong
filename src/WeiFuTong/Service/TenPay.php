...
class TenPay extends PayBase
{
     ...
     * @return array
     */
    public function tenpayJsPay($data, $timeOut = 25, $logPath = '1')
    {
     ...
     * @return array
     */
    public function tenpayNative($data, $timeOut = 25, $logPath = '1')
    {
        $this->setTimeOut($timeOut);
     ...
     * @return array
     */
    public function tenpayWapPay($data, $timeOut = 25, $logPath = '1')
    {
        $this->setTimeOut($timeOut);
